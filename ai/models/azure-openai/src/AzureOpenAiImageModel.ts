...
export interface AzureOpenAiImageClientLike {
    images: {
        generate(params: any): Promise<any>;
    };
}

export class AzureOpenAiImageModel implements ImageModel {
    private readonly client: AzureOpenAiImageClientLike;
    private readonly defaultOptions: ImageOptions;

    constructor(client: AzureOpenAiImageClientLike, defaultOptions?: ImageOptions) {
        this.client = client;
        this.defaultOptions = {
            model: "dall-e-3",
            n: 1,
