...
export interface AzureOpenAiClientLike {
    chat: {
        completions: {
...
export class AzureOpenAiChatModel implements ChatModel {
    private readonly client: AzureOpenAiClientLike;
    private readonly defaultOptions: AzureOpenAiChatOptions;

    constructor(client: AzureOpenAiClientLike, defaultOptions?: AzureOpenAiChatOptions) {
        this.client = client;
        this.defaultOptions = {
            model: "gpt-4o",
            temperature: 0.7,
    ...
    async call(prompt: PromptLike): Promise<ChatResponse> {
        ...
        const options: AzureOpenAiChatOptions = {...this.defaultOptions, ...promptOptions};
