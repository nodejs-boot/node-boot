...
description: Use when the user wants to run or deploy a Node-Boot application as a long-lived HTTP server and needs to choose or configure a framework adapter — Express, Fastify, Koa, native Node http, Encore.ts, or the GhostServer no-HTTP mode.
---
